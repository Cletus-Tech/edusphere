...
class Win32Window {
 public:
  ...
  // other window properties. Returns nullptr if the window has not been
  // created.
  HWND GetHandle();
 ...
 protected:
  // Processes and route salient window messages for mouse and pointer
  // events.
 ...
 private:
  ...
  // create the window instance pointer, then dispatches to the instance's
  // MessageHandler for all subsequent messages.
  ...
  // Updates the theme of the native window to match the system theme.
