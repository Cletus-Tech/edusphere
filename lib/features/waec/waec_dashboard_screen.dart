        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const AppChip(label: 'WAEC', icon: Icons.school_rounded, accent: AppColors.accentTeal, selected: true),
              const SizedBox(height: 12),
              GridView.count(
                crossAxisCount: 2,
                shrinkWrap: true,
                ...
                children: [
                  ...
                  _DashboardTile(
                    ...
                    onTap: () => Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const PerformancePlaceholderScreen(title: 'WAEC Performance'),
                      ),
                    ),
                  ),
                  _DashboardTile(
